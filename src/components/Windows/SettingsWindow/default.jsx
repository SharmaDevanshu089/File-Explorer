...
export function SettingsWindow() {
  ...
  const [initial_directory_path, set_initial_directory_path] =
    useState("Loading ... ");
  ...
  async function handleInputClick() {
    console.log(
      "Initial directory input has been clicked. Opening folder dialog...",
    );
    try {
      await invoke("update_initial_directory");
      console.log(
        "Backend directory update completed. Re-fetching directory...",
      );
      const data = await invoke("get_default_current_directory");
      set_initial_directory_path(data);
    } catch (err) {
      ...
      <div className="Config_panel">
        <div className="initial_directory_panel">
          <div className="setting-info">
            ...
            <p>
              This is the Startup or Default Directory for the application.
              Default this is your home directory.
            </p>
          </div>
          {/*
